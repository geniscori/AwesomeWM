...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, "Control" },"p" , function() awful.util.spawn("flameshot gui") end,
    ...
    awful.util.spawn("bash /home/genisgui/.config/awesome/poweroff") end,
              {description = "poweroff sistem", group = "launcher"}),
    awful.key({ modkey }, "x",
              function ()
                  awful.prompt.run {
                    prompt       = "Run Lua code: ",
                    ...
                    history_path = awful.util.get_rcache_dir() .. "/history_eval"
                  }
              end,
