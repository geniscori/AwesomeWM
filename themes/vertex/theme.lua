...
theme.wallpaper					                = "/usr/share/backgrounds/wallpapers-derek-taylor/wallpapers/"
...
theme.useless_gap                               = dpi(0) --canviat de 5 a 0
...
function theme.vertical_wibox(s)
    ...
    s.dockheight = (22 *  s.workarea.height)/100
